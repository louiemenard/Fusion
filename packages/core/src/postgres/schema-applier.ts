...
/* FNXC:WorkspaceWorktree 2026-08-29-23:50: FN-179's 0067 landed on main while this branch held 0067/0068, so the two workspace-worktree migrations renumbered to 0068/0069 and the ceiling advances to 0069. */
...
/* FNXC:WorkspaceWorktree 2026-08-29-23:50: renumbered 0067->0068 because origin/main released FN-179's session-contention wait state as 0067 while this branch was open. */
export const WORKSPACE_WORKTREE_DIR_SEGMENT_VERSION = "0068";
...
export const WORKSPACE_WORKTREE_DIR_SEGMENT_UNIQUE_VERSION = "0069";
...
const WORKSPACE_WORKTREE_DIR_SEGMENT_MIGRATION_PATH = join(MIGRATIONS_DIR, "0068_workspace_worktree_dir_segment.sql");
const WORKSPACE_WORKTREE_DIR_SEGMENT_UNIQUE_MIGRATION_PATH = join(MIGRATIONS_DIR, "0069_workspace_worktree_dir_segment_unique.sql");
  ...
  */
  ...
  // NOT EXISTS), so re-running is safe.
    ...
    */
    ...
    /* FNXC:WorkspaceWorktree 2026-08-24-06:10: register 0068 explicitly so an upgraded project gets the pinned workspace task-directory column before acquisition writes it. */
    ...
    /* FNXC:WorkspaceWorktree 2026-08-25-08:12: register 0069 explicitly; without the unique claim two tasks can persist the same write-once segment and contend for one directory permanently. */
